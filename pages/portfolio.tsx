...
<div className="flex flex-wrap justify-center gap-6">
  ...
  <div className="w-full lg:w-[30%] max-w-[400px] mx-2 mb-4 lg:mb-0">
    <div className="overflow-hidden bg-gray-100 border-2 rounded-lg shadow-lg cursor-pointer dark:bg-gray-800 dark:hover:border-violet-800 hover:border-yellow-500">
      <img className="object-cover w-full h-60 md:h-72 relative overflow-hidden" style={{ width: '400px', height: 'auto' }} loading="lazy" src="https://i.ibb.co/rxyZFWL/metacrw.png" alt="People working together at a desk" />
      <div className="p-4">
      <div>
...
<div className="flex flex-wrap justify-center gap-6">
  {/* Primer elemento */}
    <div className="w-full lg:w-[30%] max-w-[400px] mx-2 mb-4 lg:mb-0">
    <div className="overflow-hidden bg-gray-100 border-2 rounded-lg shadow-lg cursor-pointer dark:bg-gray-800 dark:hover:border-violet-800 hover:border-yellow-500">
    <img className="object-cover w-full h-60 md:h-72 relative overflow-hidden" style={{ width: '400px', height: 'auto' }} loading="lazy" src="https://i.ibb.co/L9rfvK0/nexdrakpage.png" alt="People working together at a desk" />
      <div className="p-4">
      <div>
  ...
  <div className="w-full lg:w-[30%] max-w-[400px] mx-2 mb-4 lg:mb-0 ">
    <div className="overflow-hidden bg-gray-100 border-2 rounded-lg shadow-lg cursor-pointer dark:bg-gray-800 dark:hover:border-violet-800 hover:border-yellow-500">
    <img className="object-cover w-full h-60 md:h-72 relative overflow-hidden" style={{ width: '400px', height: 'auto' }} loading="lazy" src="https://i.ibb.co/ykRkdFg/tidex.png" alt="People working together at a desk" />
      <div className="p-4">
      <div>
  ...
  <div className="w-full lg:w-[30%] max-w-[400px] mx-2 mb-4 lg:mb-0">
    <div className="overflow-hidden bg-gray-100 border-2 rounded-lg shadow-lg cursor-pointer dark:bg-gray-800 dark:hover:border-violet-800 hover:border-yellow-500">
      <img className="object-cover w-full h-60 md:h-72 relative overflow-hidden" style={{ width: '400px', height: 'auto' }} loading="lazy" src="https://i.ibb.co/pfsZcLx/alopolisia.png" alt="People working together at a desk" />
      <div className="p-4">
      <div>
...
<div className="flex flex-wrap justify-center gap-6">
  {/* Primer elemento */}
    <div className="w-full lg:w-[30%] max-w-[400px] mx-2 mb-4 lg:mb-0">
    <div className="overflow-hidden bg-gray-100 border-2 rounded-lg shadow-lg cursor-pointer dark:bg-gray-800 dark:hover:border-violet-800 hover:border-yellow-500">
    <img className="object-cover w-full h-60 md:h-72 relative overflow-hidden" style={{ width: '400px', height: 'auto' }} loading="lazy" src="https://i.ibb.co/VWPkG3D/Sislog.png" alt="People working together at a desk" />
      <div className="p-4">
      <div>
  ...
  <div className="w-full lg:w-[30%] max-w-[400px] mx-2 mb-4 lg:mb-0 ">
    <div className="overflow-hidden bg-gray-100 border-2 rounded-lg shadow-lg cursor-pointer dark:bg-gray-800 dark:hover:border-violet-800 hover:border-yellow-500">
    <img className="object-cover w-full h-60 md:h-72 relative overflow-hidden" style={{ width: '400px', height: 'auto' }} loading="lazy" src="https://i.ibb.co/DG5qkTs/metacrawler2.png" alt="People working together at a desk" />
      <div className="p-4">
      <div>
  ...
  <div className="w-full lg:w-[30%] max-w-[400px] mx-2 mb-4 lg:mb-0">
    <div className="overflow-hidden bg-gray-100 border-2 rounded-lg shadow-lg cursor-pointer dark:bg-gray-800 dark:hover:border-violet-800 hover:border-yellow-500">
      <img className="object-cover w-full h-60 md:h-72 relative overflow-hidden" style={{ width: '400px', height: 'auto' }} loading="lazy" src="https://i.ibb.co/8rBdqmZ/Espejitoo.png" alt="People working together at a desk" />
      <div className="p-4">
      <div>
...
<div className="flex flex-wrap justify-center gap-6">
  ...
  <div className="w-full lg:w-[30%] max-w-[400px] mx-2 mb-4 lg:mb-0">
    <div className="overflow-hidden bg-gray-100 border-2 rounded-lg shadow-lg cursor-pointer dark:bg-gray-800 dark:hover:border-violet-800 hover:border-yellow-500">
      <img className="object-cover w-full h-60 md:h-72 relative overflow-hidden" style={{ width: '400px', height: 'auto' }} loading="lazy" src="https://i.ibb.co/hxG12bT/Cler.png" alt="People working together at a desk" />
      <div className="p-4">
      <div>
  ...
  <div className="w-full lg:w-[30%] max-w-[400px] mx-2 mb-4 lg:mb-0">
    <div className="overflow-hidden bg-gray-100 border-2 rounded-lg shadow-lg cursor-pointer dark:bg-gray-800 dark:hover:border-violet-800 hover:border-yellow-500">
    <img className="object-cover w-full h-60 md:h-72 relative overflow-hidden" style={{ width: '400px', height: 'auto' }} loading="lazy" src="https://i.ibb.co/7VGj1mR/chilltifyel.png" alt="People working together at a desk" />
      <div className="p-4">
      <div>
  ...
  <div className="w-full lg:w-[30%] max-w-[400px] mx-2 mb-4 lg:mb-0 ">
    <div className="overflow-hidden bg-gray-100 border-2 rounded-lg shadow-lg cursor-pointer dark:bg-gray-800 dark:hover:border-violet-800 hover:border-yellow-500">
    <img className="object-cover w-full h-60 md:h-72 relative overflow-hidden" style={{ width: '400px', height: 'auto' }} loading="lazy" src="https://i.ibb.co/XkJ95Wm/alumnos-crud.png" alt="People working together at a desk" />
      <div className="p-4">
      <div>
